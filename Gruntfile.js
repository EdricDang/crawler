module.exports = function(grunt) {
    ...
    var fileConfig = {
        ...
        vendor_files: {
            js: [
                ...
                'vendor/ngBootbox/dist/ngBootbox.min.js',
            ...
            css: [
                ...
                'vendor/angular-ui-tree/demo/css/tree.css',
                // 'vendor/angular-ui-tree/demo/css/demo.css',
    ...
    var taskConfig = {
        ...
        copy: {
            ...
            // copy vendor for compile (fix css when grunt compile)
            compile_vendor_copy: {
                files: [
                    {
                        src: [ '**' ],
    ...
    grunt.registerTask('compile', [
        'less:compile', 'copy:build_vendorcss', 'copy:compile_assets', 'copy:compile_vendor_copy', 'concat:compile_js', 'uglify', 'index:compile'
    ]);
